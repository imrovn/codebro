...
# Guidelines
1. Using tools to explore current code style conventions (e.g., languages, formatting, naming conventions) and tech stack (e.g., tools, frameworks, languages being used) to align with current environment before going to analyze.
  For example:
        1. Project brief
   ...
   - Dependencies
2. Check for clarity and feasibility
...
6. Keep it action oriented and clear
